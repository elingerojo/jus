...
module.exports = class Context {
  ...
  constructor () {
    ...
    this.globals =  {
      NotArrayKeysAndOwners: {}, // Used to find items in "loose pages"
      ArrayKeysAndOwners: {} // Used to find posible holders of "loose pages"
    } // start with files [] already an add the others
